package com.template.spring.demo.external.infrastructure.aspects.logs;
...
public class LogAspect {
    ...
    @Pointcut("""
            !@annotation(com.template.spring.demo.external.infrastructure.annotations.DisableAOP) &&
            !@target(com.template.spring.demo.external.infrastructure.annotations.DisableAOP)
            """)
    public void enabledAOP() {}

    @Pointcut("execution(* com.template.spring.demo.external.adapters.gateways..*.*(*))")
